...
class BaseDAOTest {
    ...
    static void setUp() {
        ...
        entityManager.createNativeQuery("insert into customer(customer_id, email, firstname, lastname, address_line1, address_line2, city, state, country, phone, zipcode, password, register_date) values(1, 'test@email.com', 'First Name', 'Last Name', 'Address Line 1', 'Address Line 2', 'City', 'State', 'CNTR', '123456789', '12345', '06c219e5bc8378f3a8a3f83b4b7e4649', '2025-04-21')", Customer.class).executeUpdate();
        entityManager.createNativeQuery("insert into book_order(order_id, customer_id, order_date, r_address_line1, r_address_line2, r_firstname, r_lastname, r_phone, r_city, r_state, r_zipcode, r_country, payment_method, total, subtotal, shipping_fee, tax, status) values(1, 1, '2025-04-21', 'Address Line 1', 'Address Line 2', 'First Name', 'Last Name', '123456789', 'City', 'State', '12345', 'CNTR', 'Method', 100.0, 80.0, 10.0, 10.0, 'Status')", BookOrder.class).executeUpdate();
