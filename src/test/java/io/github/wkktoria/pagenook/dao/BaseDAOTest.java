...
class BaseDAOTest {
    ...
    static void setUp() {
        ...
        entityManager.createNativeQuery("insert into customer(customer_id, email, fullname, address, city, country, phone, zipcode, password, register_date) values(1, 'test@email.com', 'Name', 'Address', 'City', 'Country', '123456789', '12345', '06c219e5bc8378f3a8a3f83b4b7e4649', '2025-04-21')", Customer.class).executeUpdate();
